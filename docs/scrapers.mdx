...
| `amazon` | search terms, product URLs, ASINs, seller URLs, category URLs, bestseller targets, country-specific Amazon marketplace targets, price filters, review and offer flags | `search`, `product`, `reviews`, `offers`, `seller`, `bestsellers`, `asins`, `questions`, `price-tracker` |
