...
also accepts `mode: "developers"` as an actor-compatible alias for trending
...
returns repository-shaped, issue-shaped, pull-request-shaped, developer-shaped,
or Marketplace app Records.
