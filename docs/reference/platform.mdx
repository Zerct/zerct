...
npx tovuk kv put --service service_1 CACHE session:1 '{"ok":true}' --expiration 1780272000 --json
...
npx tovuk state objects --service service_1 Room --json
npx tovuk state keys --service service_1 Room room-1 --json
...
npx tovuk state delete-value --service service_1 Room room-1 counter --json
npx tovuk state delete --service service_1 Room --json
...
```sh
npx tovuk domain add --service service_1 api.example.com --json
npx tovuk domain verify --service service_1 api.example.com --json
```
