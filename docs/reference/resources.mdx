...
<Steps>
  ...
  <Step title="Deploy after resources are ready">
    ```sh
    tovuk deploy --wait --json
    ```

    Deploy after required service resources exist. If the deploy fails, switch
    to Logs and Builds before changing resource setup.
  </Step>
</Steps>
