...
sidebarTitle: "Service Resources"
...
<Steps>
  <Step title="Confirm account and Service context">
    ...
    next actions before creating more resources.
  </Step>
  ...
  <Step title="Verify the refreshed resources">
    ...
    Confirm the new resource appears in the service resources payload and
    follow the returned `nextActions`.
  </Step>
