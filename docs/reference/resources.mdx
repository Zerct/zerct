...
description: "Create, inspect, and delete Tovuk service resources with CLI, API, and dashboard workflows."
---
...
<Steps>
  <Step title="Inspect the service snapshot">
    ```sh
    tovuk service show service_1 --json
    ```

    Use the snapshot to review current resources, capabilities,
    `accountUsage`, `billingEstimate`, and next actions before creating more
    resources.
  </Step>
