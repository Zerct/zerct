...
checks.
Do not use Unicode em dashes in tracked text. ASCII hyphen pairs remain allowed
for CLI flags, code, and normal technical text.
...
the source of truth for enabled and disabled capabilities.
