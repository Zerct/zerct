...
checks.
Do not use em dashes in tracked text. Do not use double hyphen prose in
Markdown, MDX, comments, strings, logs, or generated docs. Keep CLI flags such
as `--json` in inline code or fenced command blocks.
