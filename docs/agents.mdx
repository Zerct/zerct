...
11. Before high-throughput work, run `tovuk pricing --json` and set usage
...
Before load tests or production launch, run `tovuk pricing --json` and set
hard usage caps with `tovuk limit set`.
