...
func checkDocs() {
	...
	requireContains(limits, "5115 MiB (4.995 GiB)", "object storage single-part docs")
	requireContains(limits, "automatically switches to multipart upload above", "multipart upload automation docs")
	requireContains(readText("docs/reference/storage.mdx"), "Direct Multipart API", "multipart API docs")
	...
	requireContains(openapi, `"storageObjectMaxMib": 5237760`, "OpenAPI storage object size limit")
