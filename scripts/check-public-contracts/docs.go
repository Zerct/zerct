...
func checkDocs() {
	...
	requireContains(logsBuilds, "same activity, deploy cancel, and log API routes", "dashboard activity API parity docs")
	requireContains(logsBuilds, "Deploy rows can cancel queued build work", "dashboard activity cancel action docs")
	requireContains(llms, "Dashboard Activity is available", "llms dashboard activity guidance")
	requireContains(llms, "Deploy rows can cancel queued build work", "llms dashboard activity cancel guidance")
