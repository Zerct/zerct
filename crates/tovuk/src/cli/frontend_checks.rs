...
pub(crate) fn is_frontend_source_path(relative: &str) -> bool {
    relative
        .split('/')
        .next()
...
pub(crate) fn is_frontend_typescript_source(relative: &str) -> bool {
...
pub(crate) fn matches_ignore_ascii_case(value: &std::ffi::OsStr, candidates: &[&str]) -> bool {
    candidates
        .iter()
        .any(|candidate| value.eq_ignore_ascii_case(candidate))
}

pub(crate) fn is_frontend_javascript_source(relative: &str) -> bool {
    FRONTEND_JAVASCRIPT_EXTENSIONS
        .iter()
        .any(|extension| relative.ends_with(extension))
}

pub(crate) fn is_frontend_server_route(relative: &str) -> bool {
...
pub(crate) fn path_starts_with(path_parts: &[String], prefix: &[&str]) -> bool {
...
pub(crate) fn is_backend_javascript_or_typescript_source(relative: &str) -> bool {
...
pub(crate) fn is_javascript_or_typescript_path(relative: &str) -> bool {
