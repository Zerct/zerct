...
Agent contract:
  ...
  - Use tovuk service show <service> --json as the canonical service inspection command for status, capabilities, deploys, builds, logs, env names, domains, resources, accountUsage, billingEstimate, limits, pricing, usage caps, and next actions.
