use super::{
    api_commands::{
        billing_command, binding_command, caps_command, cron_command, domains_command, env_command,
        kv_command, logs_command, pricing, print_authenticated, queue_command, service_command,
