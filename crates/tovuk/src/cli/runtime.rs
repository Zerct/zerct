use super::{
    api_commands::{
        ...
        domains_command, env_command, kv_command, logs_command, pricing, print_authenticated,
        queue_command, service_command, sqlite_command, state_command, storage_command,
        support_command,
    },
