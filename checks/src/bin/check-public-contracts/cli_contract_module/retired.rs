...
const _: [usize; 0x0003] = [
    size_of_val(&reject_retired_cli_internals),
    size_of_val(&reject_retired_commands),
    size_of_val(&reject_retired_public_copy),
];

/// Contract implementation for `reject_retired_cli_internals`.
///
/// # Errors
///
/// Returns an error when the contract requirement cannot be verified.
pub(super) fn reject_retired_cli_internals(sources: &ContractSources) -> CheckResult {
    return reject_contains_any(
...
/// Contract implementation for `reject_retired_commands`.
///
/// # Errors
///
/// Returns an error when the contract requirement cannot be verified.
...
/// Contract implementation for `reject_retired_public_copy`.
///
/// # Errors
///
/// Returns an error when the contract requirement cannot be verified.
